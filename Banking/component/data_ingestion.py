...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            banking_data_frame["income_cat"] = pd.cut(
                banking_data_frame["median_income"],
            ...
            for train_index,test_index in split.split(banking_data_frame, banking_data_frame["income_cat"]):
                strat_train_set = banking_data_frame.loc[train_index].drop(["income_cat"],axis=1)
                strat_test_set = banking_data_frame.loc[test_index].drop(["income_cat"],axis=1)
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            tgz_file_path =  self.download_banking_data()
